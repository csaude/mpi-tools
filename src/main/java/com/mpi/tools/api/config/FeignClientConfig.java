...
public class FeignClientConfig {
...

	{
		...
		return requestTemplate -> {
			...
			requestTemplate.header("Accept", "application/json;application/text");

			String authorization = null; // (String) httpSession.getAttribute(TOKEN);

			if (authorization != null) {
				requestTemplate.header(AUTHORIZATION_HEADER, TOKEN_TYPE + " " + authorization);
			}
	...
	/**
	 * Method to create a bean to increase the timeout value, It is used to overcome
	 * the Retryable exception while invoking the feign client.
	 * 
