...
public class PersonResource {
    ...
    public ResponseEntity<Pessoa> createCategory(@Valid @RequestBody Pessoa pessoa
    ...
    /**
     * A actualizacao ainda nao funciona como deve ser
     * por causa da retorno do objecto ao saltar para a base
     * @param codigo
